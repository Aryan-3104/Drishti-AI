...
export default function EnforcementPlanner() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Day selector - tab bar + Summary bar */}
      <div className="animate-diverge-down space-y-6" style={{ animationDelay: '100ms' }}>
      ...
      {!loading && !error && plan.length > 0 && (() => {
        ...
        return (
          <div className="animate-diverge-down" style={{ animationDelay: '200ms' }}>
      ...
      {/* Deployment Map */}
      {!loading && !error && plan.length > 0 && (
        <div className="animate-diverge-left" style={{ animationDelay: '300ms' }}>
          <DeploymentMap plan={plan} dayName={DAY_NAMES[day]} />
        </div>
      )}

      {/* Table */}
      <div className="animate-diverge-right" style={{ animationDelay: '300ms' }}>
